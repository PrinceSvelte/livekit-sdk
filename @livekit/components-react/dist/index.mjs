...
function useFocusToggle({ trackSource, participant, props }) {
  ...
  const { className } = React27.useMemo(() => setupFocusToggle(), []);
...
function useMediaDevices({ kind }) {
  const deviceObserver = React28.useMemo(() => createMediaDeviceObserver(kind), [kind]);
...
function useParticipantInfo(props = {}) {
  ...
  const infoObserver = React33.useMemo(() => participantInfoObserver(p), [p]);
...
function useParticipantTile({
  ...
  const isVideoMuted = useIsMuted(Track3.Source.Camera, { participant });
  const isAudioMuted = useIsMuted(Track3.Source.Microphone, { participant });
...
import { log as log9, setupLiveKitRoom } from "@livekit/components-core";
...
function useLiveKitRoom(props) {
  ...
  React67.useEffect(() => {
    ...
    const onSignalConnected = () => {
      ...
      log9.debug("trying to publish local tracks");
      Promise.all([
  ...
  React67.useEffect(() => {
    ...
    if (!token) {
      log9.debug("no token yet");
      return;
    }
    if (!serverUrl) {
      log9.warn("no livekit url provided");
      onError == null ? void 0 : onError(Error("no livekit url provided"));
      return;
    }
    if (connect) {
      log9.debug("connecting");
      room.connect(serverUrl, token, connectOptions).catch((e) => {
        log9.warn(e);
        onError == null ? void 0 : onError(e);
      });
    } else {
      log9.debug("disconnecting because connect is false");
      room.disconnect();
    }
  }, [
    connect,
  ...
  React67.useEffect(() => {
    if (!room)
      return;
    return () => {
      log9.info("disconnecting on onmount");
      room.disconnect();
    };
  }, [room]);
...
import { createAudioAnalyser, LocalAudioTrack, RemoteAudioTrack as RemoteAudioTrack2, Track as Track4 } from "livekit-client";
...
function AudioVisualizer(_a) {
  ...
  const barCount = 7;
  const { track } = useMediaTrack(Track4.Source.Microphone, participant);
  React68.useEffect(() => {
...
function ControlBar(_a) {
  ...
  return /* @__PURE__ */ React78.createElement("div", __spreadValues({ className: "lk-control-bar" }, props), visibleControls.microphone && /* @__PURE__ */ React78.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React78.createElement(TrackToggle, { source: Track8.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React78.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React78.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React78.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React78.createElement(TrackToggle, { source: Track8.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React78.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React78.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React78.createElement(
    TrackToggle,
    {
...
function VideoConference(_a) {
  ...
  return /* @__PURE__ */ React79.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React79.createElement(
