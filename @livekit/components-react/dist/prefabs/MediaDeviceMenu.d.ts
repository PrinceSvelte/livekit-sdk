 ...
 * @public
 */
export declare const MediaDeviceMenu: ({ kind, initialSelection, onActiveDeviceChange, tracks, requestPermissions, ...props }: MediaDeviceMenuProps) => React.JSX.Element;
